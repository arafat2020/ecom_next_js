  ...
  return (
    <div className='col-span-1 min-h-[330px] rounded-md bg-gradient-to-tr from-indigo-950 via-slate-900 to-sky-900 flex flex-col shadow-xl'>
      <div className='w-full h-1/2 p-1'>
        <img src={prop.primaryImg} className='w-full h-full rounded-md' alt='img' />
      </div>
      ...
      <div className='my-3 px-3'>
        <button className='w-full rounded-3xl font-sans font-bold text-slate-100 bg-gradient-to-r from-sky-700 via-sky-600 to-sky-400 hover:bg-gradient-to-l transition p-2'>Add To Chert</button>
      </div>
    </div>
  );
}
